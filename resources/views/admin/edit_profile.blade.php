            ...
            <div class="card">
                ...
                <div class="card-body">
                        <div class="form-group">
                            ...
                            {!! Form::text('nama', $admin->nama, ['class'=>'form-control form-control-alternative','placeholder'=>'Nama']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('email', 'Email') !!}
                            {!! Form::email('email', $admin->email, ['class'=>'form-control form-control-alternative','placeholder'=>'Email']) !!}
                        </div>
                        <hr>
                        <div class="form-group">
