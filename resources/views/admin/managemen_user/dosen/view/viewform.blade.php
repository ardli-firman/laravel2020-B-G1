{!! Form::open(['route'=>['admin.managemen.dosen.destroy',$data->id],'method'=>'delete']) !!}
<a class="btn btn-sm btn-icon btn-2 btn-warning" type="button" href="{{route('admin.managemen.dosen.edit',$data->id)}}">
