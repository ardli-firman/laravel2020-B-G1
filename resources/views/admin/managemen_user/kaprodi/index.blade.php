@extends('layouts.app',['navTitle' => 'Managemen user / Kaprodi'])
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-icon btn-2 btn-warning" type="button" href="{{route('admin.managemen.kaprodi.edit',$kap->id)}}">
                                                <span class="btn-inner--icon text-white"><i class="ni ni-settings-gear-65 text-white"></i>Ubah</span>
                                            </a>
                                            {!! Form::open(['route'=>['admin.managemen.kaprodi.destroy',$kap->id],'method'=>'delete']) !!}
