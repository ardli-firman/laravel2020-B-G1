{!! Form::open(['route'=>['dosen.mahasiswa.destroy',$data->nim],'method'=>'delete']) !!}
<a class="btn btn-sm btn-icon btn-2 btn-warning" type="button" href="{{route('dosen.mahasiswa.edit',$data->nim)}}">
