@extends('layouts.app',['navTitle' => 'Managemen user / Dosen / Edit'])
    ...
    <div class="col-md-12">
        <div class="row-md-12 mt-3">
            <div class="card">
                ...
                {!! Form::open(['route'=>['kaprodi.dosen.update',$dosen->id],'method'=>'put','enctype' => 'multipart/form-data']) !!}
                <div class="card-body">
                        <div class="form-group">
                            {!! Form::label('nama', 'Nama') !!}
                            {!! Form::text('nama', $dosen->nama, ['class'=>'form-control form-control-alternative','placeholder'=>'Nama']) !!}
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-footer">
                        <a type="button" href="{{route('kaprodi.dosen.index')}}" class="btn btn-secondary">Kembali</a>
