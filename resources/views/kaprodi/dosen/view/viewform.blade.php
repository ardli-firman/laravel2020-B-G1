{!! Form::open(['route'=>['kaprodi.dosen.destroy',$data->id],'method'=>'delete']) !!}
<a class="btn btn-sm btn-icon btn-2 btn-warning" type="button" href="{{route('kaprodi.dosen.edit',$data->id)}}">
