    ...
    <div class="col-md-12">
        <div class="row-md-12 mt-3">
            <div class="card">
                ...
                {!! Form::open(['route'=>['mahasiswa.profile.update',$mahasiswa->nim],'method'=>'put']) !!}
                <div class="card-body">
                    ...
                    <div class="form-group">
                        {!! Form::label('nim', 'NIM') !!}
                        {!! Form::text('nim', $mahasiswa->nim, ['class'=>'form-control form-control-muted form-control-alternative','placeholder'=>'NIM' ]) !!}
                    </div>
                    <div class="form-group">
